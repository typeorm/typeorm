...
- **postgres:** generate `ALTER COLUMN ... TYPE` for length/precision/scale/collation changes instead of recreating columns ([#12563](https://github.com/typeorm/typeorm/issues/12563))
