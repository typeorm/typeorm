    ...
    execute() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const executors = yield Promise.all(entitiesInChunks.map((entities) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    const subjects = [];
                    ...
                    yield new SubjectDatabaseEntityLoader_1.SubjectDatabaseEntityLoader(queryRunner, subjects).load(this.mode);
