...
class ConnectionOptionsReader {
    ...
    get(name) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const allOptions = yield this.all();
    ...
    has(name) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const allOptions = yield this.load();
            if (!allOptions)
                return false;
            const targetOptions = allOptions.find(options => options.name === name || (name === "default" && !options.name));
            return !!targetOptions;
    ...
    load() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (PlatformTools_1.PlatformTools.getEnvVariable("TYPEORM_CONNECTION") || PlatformTools_1.PlatformTools.getEnvVariable("TYPEORM_URL")) {
                connectionOptions = yield new ConnectionOptionsEnvReader_1.ConnectionOptionsEnvReader().read();
            }
            else if (foundFileFormat === "js" || foundFileFormat === "cjs" || foundFileFormat === "ts") {
                const configModule = yield require(configFile);
                ...
                connectionOptions = yield new ConnectionOptionsYmlReader_1.ConnectionOptionsYmlReader().read(configFile);
            }
            else if (foundFileFormat === "yaml") {
                connectionOptions = yield new ConnectionOptionsYmlReader_1.ConnectionOptionsYmlReader().read(configFile);
            }
            else if (foundFileFormat === "xml") {
                connectionOptions = yield new ConnectionOptionsXmlReader_1.ConnectionOptionsXmlReader().read(configFile);
            }
