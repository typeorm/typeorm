...
var RelationMetadata = /** @class */ (function () {
    ...
    RelationMetadata.prototype.getEntityValue = function (entity, getLazyRelationsPromiseValue) {
        ...
        if (this.embeddedMetadata) {
            ...
            var propertyNames = tslib_1.__spreadArray([], tslib_1.__read(this.embeddedMetadata.parentPropertyNames));
    ...
    RelationMetadata.prototype.setEntityValue = function (entity, value) {
        ...
        if (this.embeddedMetadata) {
            ...
            return extractEmbeddedColumnValue_2(tslib_1.__spreadArray([], tslib_1.__read(this.embeddedMetadata.embeddedMetadataTree)), entity);
        }
        else {
    ...
    RelationMetadata.prototype.registerForeignKeys = function () {
        ...
        (_a = this.foreignKeys).push.apply(_a, tslib_1.__spreadArray([], tslib_1.__read(foreignKeys)));
    };
    /**
