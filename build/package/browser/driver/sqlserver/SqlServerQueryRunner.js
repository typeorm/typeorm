...
export class SqlServerQueryRunner extends BaseQueryRunner {
    ...
    commitTransaction() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((ok, fail) => {
                this.databaseConnection.commit((err) => __awaiter(this, void 0, void 0, function* () {
                    if (err)
                        return fail(err);
                    this.isTransactionActive = false;
    ...
    rollbackTransaction() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (beforeBroadcastResult.promises.length > 0)
                yield Promise.all(beforeBroadcastResult.promises);
            return new Promise((ok, fail) => {
                this.databaseConnection.rollback((err) => __awaiter(this, void 0, void 0, function* () {
                    if (err)
                        return fail(err);
                    this.isTransactionActive = false;
                    this.databaseConnection = null;
    ...
    query(query, parameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const promise = new Promise((ok, fail) => __awaiter(this, void 0, void 0, function* () {
                try {
    ...
    renameTable(oldTableOrName, newTableName) {
        return __awaiter(this, void 0, void 0, function* () {
            const upQueries = [];
            const downQueries = [];
            const oldTable = oldTableOrName instanceof Table ? oldTableOrName : yield this.getCachedTable(oldTableOrName);
    ...
    clearDatabase(database) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield Promise.all(allTablesResults.map((tablesResult) => __awaiter(this, void 0, void 0, function* () {
    ...
    loadTables(tableNames) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield Promise.all(dbTables.map((dbTable) => __awaiter(this, void 0, void 0, function* () {
