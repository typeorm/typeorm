...
export class CockroachQueryRunner extends BaseQueryRunner {
    ...
    startTransaction(isolationLevel) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.query("SAVEPOINT cockroach_restart");
            if (isolationLevel) {
    ...
    commitTransaction() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.storeQueries = false;
            try {
                yield this.query("RELEASE SAVEPOINT cockroach_restart");
                ...
                if (e.code === "40001") {
                    yield this.query("ROLLBACK TO SAVEPOINT cockroach_restart");
                    for (const q of this.queries) {
                        yield this.query(q.query, q.parameters);
                    }
    ...
    clearDatabase() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const sequenceDropQueries = yield this.query(selectSequenceDropsQuery);
                yield Promise.all(sequenceDropQueries.map(q => this.query(q["query"])));
                yield this.commitTransaction();
            }
            catch (error) {
