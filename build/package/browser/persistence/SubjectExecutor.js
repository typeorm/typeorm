...
export class SubjectExecutor {
                    ...
                    if (singleInsertSubjects.length > 0) {
                        for (const subject of singleInsertSubjects) {
                            ...
                            if (subject.metadata.treeType === "nested-set")
                                yield new NestedSetSubjectExecutor(this.queryRunner).insert(subject);
    ...
    executeUpdateOperations() {
        return __awaiter(this, void 0, void 0, function* () {
            yield Promise.all(this.updateSubjects.map((subject) => __awaiter(this, void 0, void 0, function* () {
    ...
    executeSoftRemoveOperations() {
        return __awaiter(this, void 0, void 0, function* () {
            yield Promise.all(this.softRemoveSubjects.map((subject) => __awaiter(this, void 0, void 0, function* () {
                if (!subject.identifier)
                    throw new SubjectWithoutIdentifierError(subject);
                // for mongodb we have a bit different updation logic
                if (this.queryRunner instanceof MongoQueryRunner) {
    ...
    executeRecoverOperations() {
        return __awaiter(this, void 0, void 0, function* () {
            yield Promise.all(this.recoverSubjects.map((subject) => __awaiter(this, void 0, void 0, function* () {
                if (!subject.identifier)
                    throw new SubjectWithoutIdentifierError(subject);
                // for mongodb we have a bit different updation logic
                if (this.queryRunner instanceof MongoQueryRunner) {
