...
export class SelectQueryBuilder extends QueryBuilder {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((this.expressionMap.skip || this.expressionMap.take) && this.expressionMap.joinAttributes.length > 0) {
                ...
                const querySelects = metadata.primaryColumns.map(primaryColumn => {
                    ...
                    const alias = DriverUtils.buildColumnAlias(this.connection.driver, "ids_" + mainAliasName, primaryColumn.databaseName);
                    return `${distinctAlias}.${columnAlias} as "${alias}"`;
                });
                rawResults = yield new SelectQueryBuilder(this.connection, queryRunner)
                ...
                if (rawResults.length > 0) {
                    ...
                    if (metadata.hasMultiplePrimaryKeys) {
                        ...
                        const alias = DriverUtils.buildColumnAlias(this.connection.driver, "ids_" + mainAliasName, metadata.primaryColumns[0].databaseName);
    ...
    loadRawResults(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const results = yield queryRunner.query(sql, parameters);
            if (this.connection.queryResultCache && (this.expressionMap.cache || cacheOptions.alwaysEnabled)) {
