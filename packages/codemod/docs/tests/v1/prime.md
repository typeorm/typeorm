...
1 file — a minified docs JS file. Not TypeORM code.

### Dependency changes

TypeORM bumped from `^0.2.26` to `^1.0.0-beta.1`. Node.js engine warning: `>= 10.*` needs updating to 20+. Dotenv warning emitted.

## Output

```
✔ Updated 1 out of 16 package.json files (0.0s)
Statistics:
  Files processed:   263
...
Transforms applied:
  ...
  Files requiring manual review:
    ...
    use-container:
      ...
      packages/prime-core/__tests__/modules/internal.ts
  Parse errors:
    docs/api/assets/js/main.js Unexpected keyword 'function'. (1:9726)
Dependency changes:
