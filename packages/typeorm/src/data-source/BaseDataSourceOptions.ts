...
export interface BaseDataSourceOptions {
     ...
     *
     * Checksums are SHA-256 of the migration name plus the SQL generated by
     * `up()` (normalized to `\n`), including bound parameters of raw queries,
     * matching Flyway/Liquibase-style SQL checksums rather than JavaScript
     * source.
     */
