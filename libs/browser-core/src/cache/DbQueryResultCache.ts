...
export class DbQueryResultCache implements QueryResultCache {
    ...
    getFromCache(options: QueryResultCacheOptions, queryRunner?: QueryRunner): Promise<QueryResultCacheOptions | undefined> {
        ...
        if (options.identifier) {
            return qb
                ...
                .setParameters({identifier: /*this.connection.driver.type === "SqlServerDriver" ? new MssqlParameter(options.identifier, "nvarchar") :*/ options.identifier})
                .getRawOne();

        } else if (options.query) {
            if (this.connection.driver.type === "OracleDriver") {
                return qb
            ...
            return qb
                ...
                .setParameters({query: this.connection.driver.type === "SqlServerDriver" ? new MssqlParameter(options.query, "nvarchar") : options.query})
                .getRawOne();
        }
    ...
    async storeInCache(options: QueryResultCacheOptions, savedCache: QueryResultCacheOptions | undefined, queryRunner?: QueryRunner): Promise<void> {
        ...
        if (this.connection.driver.type === "SqlServerDriver") { // todo: bad abstraction, re-implement this part, probably better if we create an entity metadata for cache table
            insertedValues = {
