...
export class EntityMetadataBuilder {
                ...
                entityMetadata.relations.filter(relation => relation.isOneToOne || relation.isManyToOne).forEach(relation => {
                    ...
                    if (uniqueConstraint) {
                        if (this.connection.driver.type === "MysqlDriver" || this.connection.driver.type === "AuroraDataApiDriver"
                            || this.connection.driver.type === "SqlServerDriver" || this.connection.driver.type === "SapDriver") {
                    ...
                    if (foreignKey && this.connection.driver.type === "CockroachDriver") {
                        const index = new IndexMetadata({
    ...
    protected computeEntityMetadataStep1(allEntityMetadatas: EntityMetadata[], entityMetadata: EntityMetadata) {
        ...
        if (this.connection.driver.type === "CockroachDriver") {
        ...
        if (this.connection.driver.type === "MysqlDriver" || this.connection.driver.type === "AuroraDataApiDriver" || this.connection.driver.type === "SapDriver") {
