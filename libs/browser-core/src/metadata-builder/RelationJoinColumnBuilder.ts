...
export class RelationJoinColumnBuilder {
    ...
    build(joinColumns: JoinColumnMetadataArgs[], relation: RelationMetadata): {
        ...
        if (this.connection.driver.type === "OracleDriver" && columns.every(column => column.isPrimary))
                ...
                relationalColumn = new ColumnMetadata({
                    ...
                    args: {
                        ...
                        options: {
                            ...
                            && (this.connection.driver.type === "MysqlDriver" || this.connection.driver.type === "AuroraDataApiDriver")
