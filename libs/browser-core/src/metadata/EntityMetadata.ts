...
export class EntityMetadata {
    ...
    protected buildTablePath(): string {
        ...
        if (this.schema && ((this.connection.driver.type === "PostgresDriver") || (this.connection.driver.type === "SqlServerDriver") || (this.connection.driver.type === "SapDriver"))) {
            tablePath = this.schema + "." + tablePath;
        }

        if (this.database && !(this.connection.driver.type === "PostgresDriver")) {
            if (!this.schema && this.connection.driver.type === "SqlServerDriver") {
    ...
    protected buildSchemaPath(): string | undefined {
        ...
        return this.database && !(this.connection.driver.type === "PostgresDriver") ? this.database + "." + this.schema : this.schema;
    }
