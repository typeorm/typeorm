...
export class EntityManager {
    ...
    // Public Properties
    // -------------------------------------------------------------------------
    protected entityPersistExecutorCls = EntityPersistExecutor;
    protected repositoryCls = Repository;
    ...
    async transaction<T>(
        ...
        if (this.connection.driver.type === "MongoDriver")
    ...
    save<Entity, T extends DeepPartial<Entity>>(targetOrEntity: (T | T[]) | ObjectType<Entity> | EntitySchema<Entity> | string, maybeEntityOrOptions?: T | T[], maybeOptions?: SaveOptions): Promise<T | T[]> {
        ...
        return new this.entityPersistExecutorCls(this.connection, this.queryRunner, "save", target, entity, options)
            .execute()
            .then(() => entity);
    }
     ...
     * Removes a given entity from the database.
     */
    remove<Entity>(targetOrEntity: (Entity | Entity[]) | ObjectType<Entity> | string, maybeEntityOrOptions?: Entity | Entity[] | RemoveOptions | any, maybeOptions?: RemoveOptions): Promise<Entity | Entity[]> {
        ...
        // execute save operation
        return new this.entityPersistExecutorCls(this.connection, this.queryRunner, "remove", target, entity, options)
            .execute()
            .then(() => entity);
    }
    ...
    softRemove<Entity, T extends DeepPartial<Entity>>(targetOrEntity: (T | T[]) | ObjectType<Entity> | EntitySchema<Entity> | string, maybeEntityOrOptions?: T | T[], maybeOptions?: SaveOptions): Promise<T | T[]> {
        ...
        return new this.entityPersistExecutorCls(this.connection, this.queryRunner, "soft-remove", target, entity, options)
            .execute()
            .then(() => entity);
    }
    ...
    recover<Entity, T extends DeepPartial<Entity>>(targetOrEntity: (T | T[]) | ObjectType<Entity> | EntitySchema<Entity> | string, maybeEntityOrOptions?: T | T[], maybeOptions?: SaveOptions): Promise<T | T[]> {
        ...
        return new this.entityPersistExecutorCls(this.connection, this.queryRunner, "recover", target, entity, options)
            .execute()
            .then(() => entity);
    }
    ...
    async insert<Entity>(target: ObjectType<Entity> | EntitySchema<Entity> | string, entity: QueryDeepPartialEntity<Entity> | (QueryDeepPartialEntity<Entity>[])): Promise<InsertResult> {
        ...
        if (this.connection.driver.type === "OracleDriver" && Array.isArray(entity)) {
    ...
    getRepository<Entity>(target: ObjectType<Entity> | EntitySchema<Entity> | string): Repository<Entity> {
        ...
        const newRepository = createRepository(this, metadata, this.repositoryCls, this.queryRunner);
