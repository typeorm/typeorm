 ...
 */
export abstract class AbstractSqliteDriver extends AbstractSqlDriver implements Driver {

    // -------------------------------------------------------------------------
    // Public Properties
    // -------------------------------------------------------------------------

    type = 'AbstractSqliteDriver';
     ...
     */
    protected abstract createDatabaseConnection();
}
