...
import createMysqlDriver from 'typeorm-aurora-data-api-driver';
import { AbstractSqlDriver } from '@typeorm/driver-sql-abstract';

/**
 * Organizes communication with MySQL DBMS.
 */
export class AuroraDataApiDriver extends AbstractSqlDriver implements Driver {

    // -------------------------------------------------------------------------
    // Public Properties
    // -------------------------------------------------------------------------

    type = 'AuroraDataApiDriver';
