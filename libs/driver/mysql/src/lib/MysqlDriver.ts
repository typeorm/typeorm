...
import { AbstractSqlDriver } from '@typeorm/driver-sql-abstract';
import { createPool, createPoolCluster, Pool, PoolCluster } from 'mysql';

/**
 * Organizes communication with MySQL DBMS.
 */
export class MysqlDriver extends AbstractSqlDriver implements Driver {
    ...
    async connect(): Promise<void> {
        ...
        if (this.options.replication) {
            this.poolCluster = createPoolCluster(this.options.replication);
     ...
     */
    protected createConnectionOptions(options: MysqlConnectionOptions, credentials: MysqlConnectionCredentialsOptions) {
     ...
     * Creates a new connection pool for a given database credentials.
     */
    protected createPool(connectionOptions: any): Promise<Pool> {
