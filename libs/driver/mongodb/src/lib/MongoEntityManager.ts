...
import { MongoEntityPersistExecutor } from './MongoEntityPersistExecutor';
...
export class MongoEntityManager extends EntityManager {
    ...
    protected entityPersistExecutorCls = MongoEntityPersistExecutor;
    protected repositoryCls = MongoRepository;
...
// -------------------------------------------------------------------------
     ...
     */
    bulkWrite<Entity>(entityClassOrName: ObjectType<Entity> | EntitySchema<Entity> | string, operations: BulkWriteOperation<any>[], options?: CollectionBulkWriteOptions): Promise<BulkWriteOpResultObject> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    createCollectionIndex<Entity>(entityClassOrName: ObjectType<Entity> | EntitySchema<Entity> | string, fieldOrSpec: string | any, options?: IndexOptions): Promise<string> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    createCollectionIndexes<Entity>(entityClassOrName: ObjectType<Entity> | EntitySchema<Entity> | string, indexSpecs: IndexSpecification[]): Promise<void> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    deleteOne<Entity>(entityClassOrName: ObjectType<Entity> | EntitySchema<Entity> | string, query: ObjectLiteral, options?: CommonOptions): Promise<DeleteWriteOpResultObject> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    distinct<Entity>(entityClassOrName: ObjectType<Entity> | EntitySchema<Entity> | string, key: string, query: ObjectLiteral, options?: MongoDistinctPreferences): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    dropCollectionIndex<Entity>(entityClassOrName: ObjectType<Entity> | EntitySchema<Entity> | string, indexName: string, options?: CommonOptions): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    findOneAndDelete<Entity>(entityClassOrName: ObjectType<Entity> | EntitySchema<Entity> | string, query: ObjectLiteral, options?: { projection?: Object, sort?: Object, maxTimeMS?: number }): Promise<FindAndModifyWriteOpResultObject<any>> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    findOneAndReplace<Entity>(entityClassOrName: ObjectType<Entity> | EntitySchema<Entity> | string, query: ObjectLiteral, replacement: Object, options?: FindOneAndReplaceOption): Promise<FindAndModifyWriteOpResultObject<any>> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    findOneAndUpdate<Entity>(entityClassOrName: ObjectType<Entity> | EntitySchema<Entity> | string, query: ObjectLiteral, update: Object, options?: FindOneAndReplaceOption): Promise<FindAndModifyWriteOpResultObject<any>> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    geoNear<Entity>(entityClassOrName: ObjectType<Entity> | EntitySchema<Entity> | string, x: number, y: number, options?: object): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    group<Entity>(entityClassOrName: ObjectType<Entity> | EntitySchema<Entity> | string, keys: Object | Array<any> | Function | Code, condition: Object, initial: Object, reduce: Function | Code, finalize: Function | Code, command: boolean, options?: { readPreference?: ReadPreferenceOrMode, session?: ClientSession }): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    insertMany<Entity>(entityClassOrName: ObjectType<Entity> | EntitySchema<Entity> | string, docs: ObjectLiteral[], options?: CollectionInsertManyOptions): Promise<InsertWriteOpResult<any>> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    insertOne<Entity>(entityClassOrName: ObjectType<Entity> | EntitySchema<Entity> | string, doc: ObjectLiteral, options?: CollectionInsertOneOptions): Promise<InsertOneWriteOpResult<any>> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    listCollectionIndexes<Entity>(entityClassOrName: ObjectType<Entity> | EntitySchema<Entity> | string, options?: { batchSize?: number, readPreference?: ReadPreferenceOrMode, session?: ClientSession }): CommandCursor {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    mapReduce<Entity>(entityClassOrName: ObjectType<Entity> | EntitySchema<Entity> | string, map: CollectionMapFunction<any> | string, reduce: CollectionReduceFunction<any, any> | string, options?: MapReduceOptions): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
    ...
    protected applyEntityTransformationToCursor<Entity>(metadata: EntityMetadata, cursor: Cursor<Entity> | AggregationCursor<Entity>) {
        ...
        cursor.next = function (callback?: MongoCallback<Entity>) {
            if (callback) {
