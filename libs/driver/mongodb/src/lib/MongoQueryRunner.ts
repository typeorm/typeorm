...
export class MongoQueryRunner implements QueryRunner {
    ...
    constructor(connection: Connection, mongoClient: MongoClient) {
        this.connection = connection;
        this.databaseConnection = mongoClient;
     ...
     */
    async bulkWrite(collectionName: string, operations: BulkWriteOperation<any>[], options?: CollectionBulkWriteOptions): Promise<BulkWriteOpResultObject> {
     ...
     */
    async createCollectionIndexes(collectionName: string, indexSpecs: IndexSpecification[]): Promise<void> {
     ...
     */
    deleteMany(collectionName: string, query: ObjectLiteral, options?: CommonOptions): Promise<DeleteWriteOpResultObject> {
     ...
     */
    deleteOne(collectionName: string, query: ObjectLiteral, options?: CommonOptions): Promise<DeleteWriteOpResultObject> {
     ...
     */
    distinct(collectionName: string, key: string, query: ObjectLiteral, options?: MongoDistinctPreferences): Promise<any> {
     ...
     */
    async findOneAndDelete(collectionName: string, query: ObjectLiteral, options?: FindOneAndDeleteOption): Promise<FindAndModifyWriteOpResultObject<any>> {
     ...
     */
    async findOneAndReplace(collectionName: string, query: ObjectLiteral, replacement: Object, options?: FindOneAndReplaceOption): Promise<FindAndModifyWriteOpResultObject<any>> {
     ...
     */
    findOneAndUpdate(collectionName: string, query: ObjectLiteral, update: Object, options?: FindOneAndReplaceOption): Promise<FindAndModifyWriteOpResultObject<any>> {
     ...
     */
    async geoNear(collectionName: string, x: number, y: number, options?: object): Promise<any> {
     ...
     */
    async group(collectionName: string, keys: Object | Array<any> | Function | Code, condition: Object, initial: Object, reduce: Function | Code, finalize: Function | Code, command: boolean, options?: { readPreference?: ReadPreferenceOrMode, session?: ClientSession }): Promise<any> {
     ...
     */
    async insertMany(collectionName: string, docs: ObjectLiteral[], options?: CollectionInsertManyOptions): Promise<InsertWriteOpResult<any>> {
     ...
     */
    async insertOne(collectionName: string, doc: ObjectLiteral, options?: CollectionInsertOneOptions): Promise<InsertOneWriteOpResult<any>> {
     ...
     */
    listCollectionIndexes(collectionName: string, options?: { batchSize?: number, readPreference?: ReadPreferenceOrMode, session?: ClientSession }): CommandCursor {
     ...
     */
    async mapReduce(collectionName: string, map: CollectionMapFunction<any> | string, reduce: CollectionReduceFunction<any, any> | string, options?: MapReduceOptions): Promise<any> {
     ...
     */
    updateMany(collectionName: string, query: ObjectLiteral, update: ObjectLiteral, options?: { upsert?: boolean, w?: any, wtimeout?: number, j?: boolean }): Promise<UpdateWriteOpResult> {
