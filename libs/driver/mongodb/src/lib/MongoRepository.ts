...
export class MongoRepository<Entity extends ObjectLiteral> extends Repository<Entity> {
     ...
     */
    bulkWrite(operations: BulkWriteOperation<any>[], options?: CollectionBulkWriteOptions): Promise<BulkWriteOpResultObject> {
     ...
     */
    distinct(key: string, query: ObjectLiteral, options?: MongoDistinctPreferences): Promise<any> {
     ...
     */
    findOneAndDelete(query: ObjectLiteral, options?: { projection?: Object, sort?: Object, maxTimeMS?: number }): Promise<FindAndModifyWriteOpResultObject<any>> {
     ...
     */
    findOneAndReplace(query: ObjectLiteral, replacement: Object, options?: FindOneAndReplaceOption): Promise<FindAndModifyWriteOpResultObject<any>> {
     ...
     */
    findOneAndUpdate(query: ObjectLiteral, update: Object, options?: FindOneAndReplaceOption): Promise<FindAndModifyWriteOpResultObject<any>> {
     ...
     */
    group(keys: Object | Array<any> | Function | Code, condition: Object, initial: Object, reduce: Function | Code, finalize: Function | Code, command: boolean, options?: { readPreference?: ReadPreferenceOrMode, session?: ClientSession }): Promise<any> {
     ...
     */
    insertMany(docs: ObjectLiteral[], options?: CollectionInsertManyOptions): Promise<InsertWriteOpResult<any>> {
     ...
     */
    insertOne(doc: ObjectLiteral, options?: CollectionInsertOneOptions): Promise<InsertOneWriteOpResult<any>> {
     ...
     */
    mapReduce(map: CollectionMapFunction<any> | string, reduce: CollectionReduceFunction<any, any> | string, options?: MapReduceOptions): Promise<any> {
