...
import { createPool, eventEmitter } from 'hdb-pool';
 ...
 */
export class SapDriver extends AbstractSqlDriver implements Driver {
    ...
    async connect(): Promise<void> {
        ...
        eventEmitter.on("poolError", poolErrorHandler);

        // create the pool
        this.master = createPool(dbParams, options);
