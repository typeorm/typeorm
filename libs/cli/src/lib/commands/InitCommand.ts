...
temp/`;
    ...
    protected static getUserEntityTemplate(database: string): string {
        return `import {Entity, ${database === "mongodb" ? "ObjectIdColumn, ObjectID" : "PrimaryGeneratedColumn"}, Column} from "@typeorm/core";
...
export const Routes = [{
    ...
    protected static getControllerTemplate(): string {
        return `import {getRepository} from "@typeorm/core";
