import { camelCase, Connection, ConnectionOptionsReader, createConnection } from "@typeorm/core";
...
export class MigrationGenerateCommand implements yargs.CommandModule {
    ...
    protected static getTemplate(name: string, timestamp: number, upSqls: string[], downSqls: string[]): string {
        ...
        return `import {MigrationInterface, QueryRunner} from "@typeorm/core";
...
`;
    ...
    async handler(args: yargs.Arguments) {
        ...
        try {
            ...
            if (connection.driver.type === "MysqlDriver" || connection.driver.type === "AuroraDataApiDriver") {
