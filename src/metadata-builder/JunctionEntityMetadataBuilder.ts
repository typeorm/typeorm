        ...
        const junctionColumns = referencedColumns.map((referencedColumn) => {
            ...
            const columnName =
                joinColumn && joinColumn.name
                    ? joinColumn.name
                    : this.namingStrategy.joinTableColumnName(
                          relation.entityMetadata.tableNameWithoutPrefix,
                          referencedColumn.propertyName,
        ...
        const inverseJunctionColumns = inverseReferencedColumns.map(
            (inverseReferencedColumn) => {
                ...
                const columnName =
                    joinColumn && joinColumn.name
                        ? joinColumn.name
                        : this.namingStrategy.joinTableInverseColumnName(
        ...
        junctionColumns.forEach((junctionColumn) => {
            inverseJunctionColumns.forEach((inverseJunctionColumn) => {
                if (
                    ...
                    const junctionColumnName = this.namingStrategy.joinTableColumnDuplicationPrefix(
                    ...
                    const inverseJunctionColumnName = this.namingStrategy.joinTableColumnDuplicationPrefix(
