...
export class ImportAndAddItemToInitializerArrayPropertyInCodebase {
    ...
    public constructor({
       ...
       treatImportNamespaceAsList, exportImportAllFromFileWhenImportingNamespace, moduleSystem
   }: {
        ...
        treatImportNamespaceAsList: boolean, exportImportAllFromFileWhenImportingNamespace: boolean, moduleSystem?: "esm" | "commonjs"
    }) {
