...
export class EntityMetadata {
    ...
    build() {
        ...
        if (this.tableMetadataArgs.type === "closure-junction") {
            ...
            if (this.tableMetadataArgs.noTruncate && this.connection.driver.maxAliasLength && this.connection.driver.maxAliasLength > 0 && this.tableNameWithoutPrefix.length > this.connection.driver.maxAliasLength) {
