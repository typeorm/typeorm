...
/**
 * GaussDB-specific connection options.
 */
export interface GaussDBConnectionOptions
    extends BaseDataSourceOptions,
        GaussDBConnectionCredentialsOptions {
    /**
     * Database type.
     */
    readonly type: "gaussdb"
    ...
    readonly replication?: {
         ...
         */
        readonly master: GaussDBConnectionCredentialsOptions

        /**
         * List of read-from severs (slaves).
         */
        readonly slaves: GaussDBConnectionCredentialsOptions[]
    ...
    /**
     * The milliseconds before a timeout occurs during the initial connection to the gaussdb
     * server. If undefined, or set to 0, there is no timeout. Defaults to undefined.
     */
    readonly connectTimeoutMS?: number

    // /**
    //  * The GaussDB extension to use to generate UUID columns. Defaults to uuid-ossp.
    ...
    /**
     * Include notification messages from GaussDB server in client logs
     */
