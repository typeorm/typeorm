...
export class PostgresDriver implements Driver {
    ...
    protected loadDependencies(): void {
        try {
            const postgres = (this.connection.options as PostgresConnectionOptions).driver || PlatformTools.load("pg");
            this.postgres = postgres;
            try {
                const pgNative = (this.connection.options as PostgresConnectionOptions).nativeDriver || PlatformTools.load("pg-native");
