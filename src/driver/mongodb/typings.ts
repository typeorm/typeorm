...
export interface Collection<TSchema = any> {
    ...
    /** @deprecated */
    find<T = TSchema>(query: FilterQuery<TSchema>, options?: MongodbFindOneOptions): Cursor<T>;
    ...
    findOne<T = TSchema>(filter: FilterQuery<TSchema>, options?: MongodbFindOneOptions): Promise<T | null>;
    findOne<T = TSchema>(filter: FilterQuery<TSchema>, options: MongodbFindOneOptions, callback: MongoCallback<T | null>): void;
...
export interface FindAndModifyWriteOpResultObject<TSchema = any> {
...
export declare class Cursor<T=any> extends Readable {
...
export declare class AggregationCursor<T=any> extends Readable {
...
export declare class CommandCursor extends Readable {
...
export type GridFSBucketWriteStreamId = string | number | Object | ObjectID;
