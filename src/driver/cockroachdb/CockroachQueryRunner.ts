    ...
    implements QueryRunner
{
    ...
    /**
     * Builds CockroachDB PARTITION BY clause (same as PostgreSQL).
     */
    ...
    /**
     * Creates a partition of a partitioned table in CockroachDB.
     */
    ...
    /**
     * Drops a partition from a partitioned table in CockroachDB.
     */
    async dropPartition(
        tableName: string,
    ...
    /**
     * Lists all partitions of a table in CockroachDB.
     */
