...
export class OracleDriver implements Driver {
    ...
    capabilities: DriverCapabilities = {
        // Dialect
        stringAggregation: "LISTAGG",
        pagination: "FETCH_FIRST", // Oracle 12c+ uses FETCH_FIRST, legacy uses ROWNUM
        useIndexHint: false,
        ...
        returningRequiresInto: true, // Oracle requires INTO clause
