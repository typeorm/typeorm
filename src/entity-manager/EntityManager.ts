...
export class EntityManager {
  ...
  sum<Entity extends ObjectLiteral>(
    ...
    return this.callAggregateFun(entityClass, "SUM", columnName, where, options)
  }
  ...
  average<Entity extends ObjectLiteral>(
    ...
    return this.callAggregateFun(entityClass, "AVG", columnName, where, options)
  }
  ...
  minimum<Entity extends ObjectLiteral>(
    ...
    return this.callAggregateFun(entityClass, "MIN", columnName, where, options)
  }
  ...
  maximum<Entity extends ObjectLiteral>(
    ...
    return this.callAggregateFun(entityClass, "MAX", columnName, where, options)
  }
