...
export * from "./error/CannotReflectMethodParameterTypeError";
export * from "./error/AlreadyHasActiveConnectionError";
export * from "./error/SubjectWithoutIdentifierError";
export * from "./error/CannotConnectAlreadyConnectedError";
export * from "./error/LockNotSupportedOnGivenDriverError";
export * from "./error/ConnectionIsNotSetError";
export * from "./error/CannotCreateEntityIdMapError";
export * from "./error/MetadataAlreadyExistsError";
export * from "./error/CannotDetermineEntityError";
export * from "./error/UpdateValuesMissingError";
export * from "./error/TreeRepositoryNotSupportedError";
export * from "./error/CustomRepositoryNotFoundError";
...
export * from "./error/CustomRepositoryCannotInheritRepositoryError";
export * from "./error/QueryRunnerProviderAlreadyReleasedError";
export * from "./error/CannotAttachTreeChildrenEntityError";
export * from "./error/CustomRepositoryDoesNotHaveEntityError";
export * from "./error/MissingDeleteDateColumnError";
export * from "./error/NoConnectionForRepositoryError";
export * from "./error/CircularRelationsError";
...
export * from "./error/ConnectionNotFoundError";
...
export * from "./error/DataTypeNotSupportedError";
