...
export class SoftDeleteQueryBuilder<Entity> extends QueryBuilder<Entity> implements WhereExpression {
    ...
    constructor(connectionOrQueryBuilder: Connection, queryRunner: QueryRunner, expressionMap: QueryExpressionMap) {
        super(connectionOrQueryBuilder, queryRunner, expressionMap);
    ...
    async execute(): Promise<UpdateResult> {
        ...
        try {
            ...
            if (this.expressionMap.callListeners === true && this.expressionMap.mainAlias!.hasMetadata) {
                ...
                this.queryRunner.broadcaster.broadcastBeforeUpdateEvent(broadcastResult, this.expressionMap.mainAlias!.metadata);
