...
View Column options define additional options for your view entity columns, similar to [column options](../Entity/1-entities.md#column-options) for regular entities.
