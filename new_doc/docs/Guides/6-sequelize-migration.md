...
Learn more about [Active Record vs Data Mapper](../Guides/1-active-record-data-mapper.md) and [Repository API](../Working%20with%20Entity%20Manager/6-repository-api.md).
