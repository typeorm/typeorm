      ...
      try {
         if (connection.driver instanceof MysqlDriver) {
            ...
            await UserRepository
                .createQueryBuilder()
                .insert()
                .orUpdate(false, { is_updated: user1.is_updated })
                .into(User)
                .values(user1)
                .execute();
             await UserRepository
                .createQueryBuilder()
                .insert()
                .orUpdate(false, { is_updated: user2.is_updated })
                .into(User)
                .values(user2)
                .execute();
         ...
         try {
            if (connection.driver instanceof PostgresDriver) {
                ...
                await UserRepository
                    .createQueryBuilder()
                    .insert()
                    .orUpdate(false, { is_updated: user1.is_updated }, ["first_name", "last_name"])
                    .into(User)
                    .values(user1)
                    .execute();
                 await UserRepository
                    .createQueryBuilder()
                    .insert()
                    .orUpdate(false, { is_updated: user2.is_updated }, ["first_name", "last_name"])
                    .into(User)
                    .values(user2)
                    .execute();
                 let loadedUser_3 = await UserRepository.find();
                ...
                await UserRepository
                    .createQueryBuilder()
                    .insert()
                    .orUpdate(false, { is_updated: user1.is_updated }, "ON CONSTRAINT constraint_unique_idx")
                    .into(User)
                    .values(user1)
                    .execute();
                 await UserRepository
                    .createQueryBuilder()
                    .insert()
                     .orUpdate(false, { is_updated: user2.is_updated }, "ON CONSTRAINT constraint_unique_idx")
                    .into(User)
                    .values(user2)
                    .execute();
