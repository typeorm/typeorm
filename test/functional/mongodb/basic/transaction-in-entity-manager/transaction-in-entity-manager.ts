// copied test from test/functional/transaction/transaction-in-entity-manager/transaction-in-entity-manager.ts
// TODO requires setting up replica sets in docker image to work in CI
// except the Entities have their PrimaryIdColumn swapped out for ObjectIdColumn due to the test not working in its current state
...
describe("mongo > transaction with entity manager", () => {
