...
了解有关[View Entities](view-entities)的更多信息。
...
-   `type: ColumnType` - 列类型。受支持的[supported column types](entities/#column-types)其中之一。
...
了解有关[entity columns](entities/#entity-columns)的更多信息。
...
了解有关[一对一关系](one-to-one-relations)的更多信息。
...
了解有关[多对一/一对多关系](many-to-one-one-to-many-relations)的更多信息。
...
了解有关 [多对多关系](many-to-many-relations)的更多信息。
...
了解有关[listeners](listeners-and-subscribers)的更多信息。
...
了解有关 [subscribers](listeners-and-subscribers)的详细信息
...
了解有关 [transactions](transactions)的更多信息。
...
了解有关 [custom entity repositories](custom-repository)的更多信息。
