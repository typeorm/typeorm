...
* [一对一](./one-to-one-relations) 使用 `@OneToOne`
* [多对一](./many-to-one-one-to-many-relations) 使用 `@ManyToOne`
* [一对多](./many-to-one-one-to-many-relations) 使用 `@OneToMany`
* [多对多](./many-to-many-relations) 使用 `@ManyToMany`
