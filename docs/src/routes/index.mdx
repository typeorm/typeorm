...
description: TypeORM - TypeORM is an ORM that can run in NodeJS, Browser, Cordova, PhoneGap, Ionic, React Native, NativeScript, Expo, and Electron platforms and can be used with TypeScript and JavaScript (ES2021)
---

<div align="center">
  <a href="http://typeorm.io/">
    <img src="https://github.com/typeorm/typeorm/raw/master/resources/logo_big.png" alt="TypeORM logo" width="492" height="228" />
  </a>
  <br />
  <br />
	{/* <a href="https://app.circleci.com/pipelines/github/typeorm/typeorm" aria-label="circleci statistics" >
		<img src="https://circleci.com/gh/typeorm/typeorm/tree/master.svg?style=shield" alt="circleci statistics" />
	</a>
	<a href="https://badge.fury.io/js/typeorm" aria-label="fury badge" >
		<img src="https://badge.fury.io/js/typeorm.svg" alt="fury badge" />
	</a>
  <a href="https://codecov.io/gh/typeorm/typeorm" aria-label="typeorm logo" >
...
TypeORM supports both [Active Record](./docs/active-record-data-mapper/#what-is-the-active-record-pattern) and [Data Mapper](./docs/active-record-data-mapper/#what-is-the-data-mapper-pattern) patterns,
...
>
> [Read the full announcement](./docs/future-of-typeorm)

## Features

-   Supports both [DataMapper](./docs/active-record-data-mapper/#what-is-the-data-mapper-pattern) and [ActiveRecord](./docs/active-record-data-mapper/#what-is-the-active-record-pattern) (your choice).
...
4. Install a database driver:
    ...
    - for **NativeScript**, **react-native** and **Cordova**
        ...
        Check [documentation of supported platforms](./docs/supported-platforms)
...
[More information on supported column types can be found here](./docs/entities/#column-types).
...
[Learn more about EntityManager here](./docs/working-with-entity-manager).
...
[Learn more about Repository here](./docs/working-with-repository).
...
Learn more about Find Options in [this documentation](./docs/find-options).
...
[Learn more about QueryBuilder here](./docs/select-query-builder).
...
[Learn about contribution here](https://github.com/typeorm/typeorm/blob/master/CONTRIBUTING) and [how to set up your development environment here](https://github.com/typeorm/typeorm/blob/master/DEVELOPER).

This project exists thanks to all the people who contribute:

<a href="https://github.com/typeorm/typeorm/graphs/contributors" aria-label="opencollective statistics"><img alt="opencollective statistics" loading="lazy" fetchPriority="low" src="https://opencollective.com/typeorm/contributors.svg?width=890&showBtn=false" /></a>
...
<a href="https://opencollective.com/typeorm" target="_blank" aria-label="opencollective statistics"><img alt="opencollective statistics" src="https://opencollective.com/typeorm/tiers/sponsor.svg?width=890" /></a>
...
<a href="https://opencollective.com/typeorm" target="_blank" aria-label="opencollective statistics"><img alt="opencollective statistics" src="https://opencollective.com/typeorm/tiers/gold-sponsor.svg?width=890" /></a>
