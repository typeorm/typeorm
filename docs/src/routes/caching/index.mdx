...
"options" can be [node_redis specific options](https://github.com/redis/node-redis/blob/master/docs/client-configuration) or [ioredis specific options](https://github.com/luin/ioredis/blob/master/API/#new-redisport-host-options) depending on what type you're using.
