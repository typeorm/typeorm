...
-   [one-to-one](./one-to-one-relations) using `@OneToOne`
-   [many-to-one](./many-to-one-one-to-many-relations) using `@ManyToOne`
-   [one-to-many](./many-to-one-one-to-many-relations) using `@OneToMany`
-   [many-to-many](./many-to-many-relations) using `@ManyToMany`
