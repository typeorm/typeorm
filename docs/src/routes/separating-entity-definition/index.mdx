...
the documentation on [concrete table inheritance](entity-inheritance/#concrete-table-inheritance).
...
In order to use [Single Table Inheritance](entity-inheritance/#single-table-inheritance):
