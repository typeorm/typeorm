...
-   `cache` - Enables or disables query result caching. See [caching](caching) for more information and options.
...
See [lock modes](./select-query-builder/#lock-modes) for more information
