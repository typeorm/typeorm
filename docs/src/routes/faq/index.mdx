...
and add extra columns in there. You can read more about this in [Many-to-Many relations](./many-to-many-relations/#many-to-many-relations-with-custom-properties).
